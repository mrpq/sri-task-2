[Демо](https://tranquil-thicket-93129.herokuapp.com/event/create) *может потребоваться время во время первого открвания, так как демка на бесплатном аккаунте heroku. Попробуйте обновить страницу через некоторое время после открытия ссылки
...
Сборщик заускается коммандой tars dev (необходима предварительная установка [TARS-CLI](https://github.com/tars/tars-cli)

Ниже подробная документация по сборщику на русском и английском.
